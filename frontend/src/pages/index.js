    ...
    <div className="min-h-screen gradient-fpl flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-white rounded-xl shadow-2xl p-8">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-fpl-purple focus:border-transparent outline-none text-lg"
                  disabled={loading}
                />
          ...
          <div className="mt-6 p-4 bg-fpl-purple bg-opacity-5 rounded-lg">
