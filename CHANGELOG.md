...
### Changes
- feat: add side-by-side squad comparison view with tab toggle (#41) (31b37e1)
...
### Changes
- feat: add automated player news feed and team articles tab (#38) (76c446f)
...
### Changes
- fix: add defensive contributions (DEFCON) points and fix points breakdown (#30) (40aa6b5)
...
### Changes
- fix(docker): use npm install instead of npm ci (no lockfiles) (f04ae62)

## [v2.12.0] - 2026-02-07

### Changes
- feat(infra): add production deployment workflow with Lightsail support (301ad31)

## [v2.11.0] - 2026-01-31

### Changes
- feat(backend): add Official FPL Podcast insights extraction (#24) (c364dfb)

## [v2.10.2] - 2026-01-23

### Changes
- fix: add gameweek status indicators and real-time team value calculation (#23) (5c75bfb)

## [v2.10.1] - 2026-01-23

### Changes
- fix: improve transfer plan view with shareable links and mobile responsiveness (#22) (7c35cd2)
